...
Badge Type	Style Rationale
New Arrival	Solid Green (bg-[#1a4332]) to signify growth and freshness.
Best Seller	White with Border to look clean and verified.
Sold Out	Desaturated Red/Grey to signal unavailability without being "aggressive."
