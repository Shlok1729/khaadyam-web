...
export default function AdminNewProduct() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl">
       <Link href="/admin/products" className="flex items-center gap-2 text-neutral-400 font-bold text-sm mb-8 hover:text-[#1a4332] transition-colors group">
          <ArrowLeft size={16} className="group-hover:-translate-x-1 transition-transform" />
          Back to Inventory
       </Link>

       <div className="mb-12">
            <h1 className="font-serif text-4xl font-bold text-neutral-900 mb-2 font-serif">Add New Product</h1>
            <p className="text-neutral-500 font-light italic">Curate another piece of Malnad heritage.</p>
       </div>
